...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-UDAM3NC\\SQLEXPRESS04;Initial Catalog=TrabajadoresPrueba;Integrated Security=SSPI;TrustServerCertificate=True; User ID=sa;Password=********;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Departamento>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Departam__3214EC0705B92235");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Distrito__3214EC072DEEF196");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Provinci__3214EC0775D26B25");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Trabajad__3214EC0772AAAFF9");
